...
<head>
    ...
    <title>HotelCamplong - Point Of Sale</title>
	<!-- Bootstrap Styles-->
    ...
    <div id="wrapper"> 
        <nav class="navbar navbar-default top-navbar" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo base_url() ?>">HotelCamplong</a>
            </div>
        ...
        <div id="page-wrapper" >
            ...
            <!-- /. PAGE INNER  -->
            <footer><p>Website : <a href="http://sourcecodeaplikasi.info" target="_blank">Richisoft</a></p></footer>
        </div>
        <!-- /. PAGE WRAPPER  -->
    </div>
